...
SpriteDef firstFramePlayerIdleBack = {"enter_the_gungeon_spritesheet.png",
                                      Rect{playerIdleBackPosition.x,
                                           playerIdleBackPosition.y,
                                           spriteWidth, spriteHeight},
                                      spriteWidth, spriteHeight};

const Point playerIdleSidePosition = {21, 66};
SpriteDef firstFramePlayerIdleSize = {"enter_the_gungeon_spritesheet.png",
                                      Rect{playerIdleSidePosition.x,
                                           playerIdleSidePosition.y,
                                           spriteWidth, spriteHeight},
                                      spriteWidth, spriteHeight};

const Point playerIdleFrontPosition = {21, 37};
SpriteDef firstFramePlayerIdleFront = {"enter_the_gungeon_spritesheet.png",
                                       Rect{playerIdleFrontPosition.x,
                                            playerIdleFrontPosition.y,
                                            spriteWidth, spriteHeight},
                                       spriteWidth, spriteHeight};

const Point playerWalkingFrontPosition = {22, 187};
SpriteDef firstFramePlayerWalkingFront = {"enter_the_gungeon_spritesheet.png",
                                          Rect{playerWalkingFrontPosition.x,
                                               playerWalkingFrontPosition.y,
                                               spriteWidth, spriteHeight},
                                          spriteWidth, spriteHeight};

const Point playerWalkingBackPosition = {20, 251};
SpriteDef firstFramePlayerWalkingBack = {"enter_the_gungeon_spritesheet.png",
                                         Rect{playerWalkingBackPosition.x,
                                              playerWalkingBackPosition.y,
                                              spriteWidth, spriteHeight},
                                         spriteWidth, spriteHeight};
...
SpriteDef firstFramePlayerWalkingBackSide = {
    ...
    Rect{playerWalkingBackSidePosition.x, playerWalkingBackSidePosition.y, 17,
         27},
    17, 27};
...
SpriteDef firstFramePlayerWalkingFrontSide = {
    "enter_the_gungeon_spritesheet.png",
    Rect{playerWalkingFrontSidePosition.x, playerWalkingFrontSidePosition.y, 17,
         27},
    17, 27};
...
void PlayerPrefabFactory::setTag(GameObject *gameObject) {
...
void PlayerPrefabFactory::addAnimations(GameObject *gameObject) {
...

  {
    ...
    std::vector<SpriteDef> playerAnimationIdleBack = {
        playerIdleBackAnimationFrames[0], playerIdleBackAnimationFrames[1],
        playerIdleBackAnimationFrames[2], playerIdleBackAnimationFrames[1]};

    playerIdleBackAnimation =
        EngineBravo::getInstance().getResourceManager().loadAnimation(
            playerAnimationIdleBack, 200, true);
  }
  {
    ...
    std::vector<SpriteDef> playerAnimationIdleSide = {
        playerIdleSideAnimationFrames[0], playerIdleSideAnimationFrames[1],
        playerIdleSideAnimationFrames[2], playerIdleSideAnimationFrames[1]};

    playerIdleSideAnimation =
        EngineBravo::getInstance().getResourceManager().loadAnimation(
            playerAnimationIdleSide, 200, true);
  }
  {
    ...
    std::vector<SpriteDef> playerAnimaionIdleFront = {
        playerIdleFrontAnimationFrames[0], playerIdleFrontAnimationFrames[1],
        playerIdleFrontAnimationFrames[2], playerIdleFrontAnimationFrames[1]};

    playerIdleFrontAnimation =
        EngineBravo::getInstance().getResourceManager().loadAnimation(
            playerAnimaionIdleFront, 200, true);
  }

  {
    ...
    std::vector<SpriteDef> playerAnimationWalkingBack =
        playerWalkingBackAnimationFrames;

    playerWalkingBackAnimation =
        EngineBravo::getInstance().getResourceManager().loadAnimation(
            playerAnimationWalkingBack, 100, true);
  }
  {
    ...
    std::vector<SpriteDef> playerAnimationWalkingFront =
        playerWalkingFrontAnimationFrames;

    playerWalkingFrontAnimation =
        EngineBravo::getInstance().getResourceManager().loadAnimation(
            playerAnimationWalkingFront, 100, true);
  }
  {
    ...
    std::vector<SpriteDef> playerAnimationWalkingBackSide =
        playerWalkingBackSideAnimationFrames;

    playerWalkingBackSideAnimation =
        EngineBravo::getInstance().getResourceManager().loadAnimation(
            playerAnimationWalkingBackSide, 100, true);
  }
  {
    std::vector<SpriteDef> playerWalkingFrontSideAnimationFrames =
        SpriteDefUtil::extrapolateSpriteDef(firstFramePlayerWalkingFrontSide,
                                            6);

    std::vector<SpriteDef> playerAnimationWalkingFrontSide =
        playerWalkingFrontSideAnimationFrames;

    playerWalkingFrontSideAnimation =
        EngineBravo::getInstance().getResourceManager().loadAnimation(
            playerAnimationWalkingFrontSide, 100, true);
  }
...
void PlayerPrefabFactory::addParticleEmitter(GameObject *gameObject) {
  ...
  std::vector<Color> colors = {Color(255, 49, 3, 170), Color(255, 100, 3, 150),
                               Color(0, 0, 0, 90), Color(0, 0, 0, 90)};

  ParticleEmitter *emitter = new ParticleEmitter(
      emitterMode, speed, acceleration, minLifeTimeMs, maxLifeTimeMs, startSize,
      endSize, rotation, rotationSpeed, rotationAcceleration, colors);
