...
GameObject* LevelManagerFactory::createLevelManagerPrefab() {
    ...
    LevelManagerBehaviourScript* levelManagerBehaviourScript = levelManagerPrefab->getComponents<LevelManagerBehaviourScript>().at(0);
...
void LevelManagerFactory::setTag(GameObject* gameObject) {
    gameObject->setTag("LevelManager");
}
